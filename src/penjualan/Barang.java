...
public class Barang extends javax.swing.JFrame {
    ...
    private void tblDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tblDeleteActionPerformed
        ...
        try {
            ...
            String sql = "DELETE FROM barang WHERE kodebrg=?";
    ...
    public void insert(String kode, String nama, String satuan, int stok, int stokmin){
        try {
            ...
            String sql = "INSERT INTO barang (kodebrg, namabrg, satuanbrg, stokbrg, minbrg) VALUES (?,?,?,?,?)";
    ...
    public void update(String kode, String nama, String satuan, int stok, int stokmin){
        try {
            ...
            String sql = "UPDATE barang SET kodebrg=?, namabrg=?, satuanbrg=?, stokbrg=?, minbrg=? WHERE kodebrg='"+kode+"'";
